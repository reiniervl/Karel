call mvn install:install-file -Dfile=jlc-1.4.7.jar -DpomFile=installs/jlc-1.4.7.pom.xml
call mvn install:install-file -Dfile=se.skillytaire.course.tools.junit.jlc.processor-1.4.7.jar -DpomFile=installs/se.skillytaire.course.tools.junit.jlc.processor-1.4.7.pom.xml

call mvn install:install-file -Dfile=se.skillytaire.didactic.generator-1.0.2.jar -DpomFile=installs/se.skillytaire.didactic.generator-1.0.2.pom.xml
call mvn install:install-file -Dfile=se.skillytaire.didactic.annotation.fluent-1.0.2.jar -DpomFile=installs/se.skillytaire.didactic.annotation.fluent-1.0.2.pom.xml

call mvn install:install-file -Dfile=se.skillytaire.java.datatype-1.0.0.jar -DpomFile=installs/datatype-pom.xml
...
call mvn install:install-file -Dfile=se.skillytaire.service.wheater.api-1.0.1.jar -DpomFile=installs/wheater.api-pom.xml
...
call mvn install:install-file -Dfile=se.skillytaire.service.wheater.klart-1.0.1.jar -DpomFile=installs/wheater.klart-pom.xml
...
call mvn install:install-file -Dfile=Builder-0.9.8.jar -DpomFile=installs/Builder-0.9.8.pom.xml
